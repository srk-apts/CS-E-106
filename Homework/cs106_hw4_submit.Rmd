...
*Residual Plot:* There seems to be a few ouliers or no visible non-linearity. The error term does not have constant variance.
...
```{r}
ei = lm_plastic$residuals
fitted_values = lm_plastic$fitted.values
...
#residual standard error = 3.234 from summary(lm) above
zr1 = sqrt(3.234)*qnorm(zr)
...
g = nrow(Xh)
alpha = 0.1
CI.New = predict.lm(lm_plastic, Xh, se.fit= TRUE, level = 1-alpha)
